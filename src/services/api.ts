...
export const apiService = {
  ...
  createInstance: (instanceName: string, userId: number, botName: string) =>
    api.post('evolution/create', { instanceName, userId, botName }),
  ...
  deleteInstance: (instanceName: string) => api.delete('evolution/delete', { data: { instanceName } }),
